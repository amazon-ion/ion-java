...
// FIXME: should this be here or not???? checkLeadingSymbolTable(dg);
    ...
    public void testAddingDatagramToDatagram()
    {
        ...
        // Cannot insert a datagram  // TODO amazon-ion/ion-java/issues/48
//        try
//        {
//            dg1.add(1, dg2);
//            fail("Expected IllegalArgumentException");
...
//        testEmptySequence(dg); // TODO amazon-ion/ion-java/issues/48 implement add(int,v)
        dg.add().newInt(1);
    ...
    {
        // TODO amazon-ion/ion-java/issues/51 implement remove on datagram iterator
    }
    ...
    {
        // TODO amazon-ion/ion-java/issues/8 I think this is wrong, the datagram has injected IVM
