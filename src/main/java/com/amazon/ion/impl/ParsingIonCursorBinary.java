...
class ParsingIonCursorBinary extends IonCursorBinary implements IonReaderContinuableCore {
     ...
     */
    java.nio.ByteBuffer prepareByteBuffer(long startIndex, long endIndex) {
     ...
     * @return the value.
     */
    private static double readFloat16(java.nio.ByteBuffer byteBuffer) {
    ...
    public double doubleValue() {
        ...
        if (valueTid.type == IonType.FLOAT) {
            ...
            java.nio.ByteBuffer bytes = prepareByteBuffer(valueMarker.startIndex, valueMarker.endIndex);
    ...
    String readString() {
        ...
        prepareScalar();
        java.nio.ByteBuffer utf8InputBuffer = prepareByteBuffer(valueMarker.startIndex, valueMarker.endIndex);
