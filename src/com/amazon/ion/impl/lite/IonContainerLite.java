    ...
    implements _Private_IonContainer, IonContext
{
    ...
    // Doubles the size of a stack of CloneContext objects.
     ...
     * @param isDatagram true if the container being cloned is a datagram.
     */
    ...
    final IonContainerLite deepClone() {
        boolean isDatagramBeingCloned = this instanceof IonDatagramLite;
