    ...
    extends IonTestCase
{
    ...
    static class TestValue {
        ...
        /** TODO amazon-ion/ion-java/issues/5 why this context? I think it will round-off values */
...
*/
               ...
               new TestValue("int0",          IonType.INT, Integer.valueOf(0) ),
               new TestValue("intneg1",       IonType.INT, Integer.valueOf(-1) ),
               new TestValue("int1",          IonType.INT, Integer.valueOf(1) ),
               new TestValue("intneg32766",   IonType.INT, Integer.valueOf(-32766) ),
               new TestValue("int32767",      IonType.INT, Integer.valueOf(32767) ),
               new TestValue("int-2g",        IonType.INT, Integer.valueOf(-2000000000) ),
               new TestValue("int2g",         IonType.INT, Integer.valueOf(2000000000) ),
               new TestValue("intmin",        IonType.INT, Integer.MIN_VALUE ),
               new TestValue("intmax",        IonType.INT, Integer.MAX_VALUE ),

               new TestValue("long0",         IonType.INT, Long.valueOf(0L) ),
               new TestValue("long-1",        IonType.INT, Long.valueOf(-1L) ),
               new TestValue("long1",         IonType.INT, Long.valueOf(1L) ),
               new TestValue("long-4g",       IonType.INT, Long.valueOf(-4000000000L) ),
               new TestValue("long4g",        IonType.INT, Long.valueOf(4000000000L) ),
               new TestValue("longmin",       IonType.INT, Long.valueOf(Long.MIN_VALUE + 1) ),  // we don't reach all the way to MIN_VALUE since we have to negate it for writing (to get the positive value)
               new TestValue("longmin2",      IonType.INT, Long.valueOf(-Long.MAX_VALUE) ),
               new TestValue("longmax",       IonType.INT, Long.MAX_VALUE ),

               new TestValue("float_0",       IonType.FLOAT, Float.valueOf(0.0f) ),
               new TestValue("float_n0",      IonType.FLOAT, Float.valueOf(-0.0f) ),
               new TestValue("float_a",       IonType.FLOAT, Float.valueOf(-1.0f) ),
               new TestValue("float_b",       IonType.FLOAT, Float.valueOf(1.0f) ),
               new TestValue("float_c",       IonType.FLOAT, Float.valueOf(-1e10f) ),
               new TestValue("float_d",       IonType.FLOAT, Float.valueOf(1e-10f) ),
               new TestValue("float_e",       IonType.FLOAT, Float.valueOf(0.1f) ),
               new TestValue("float_f",       IonType.FLOAT, Float.valueOf(-0.1f) ),
               ...
               new TestValue("double_0",      IonType.FLOAT, Double.valueOf(0.0) ),
               new TestValue("double_n0",     IonType.FLOAT, Double.valueOf(-0.0) ),
               new TestValue("double_a",      IonType.FLOAT, Double.valueOf(-1.0) ),
               new TestValue("double_b",      IonType.FLOAT, Double.valueOf(1.0) ),
               new TestValue("double_c",      IonType.FLOAT, Double.valueOf(-1e10) ),
               new TestValue("double_d",      IonType.FLOAT, Double.valueOf(1e-10) ),
               new TestValue("double_e",      IonType.FLOAT, Double.valueOf(0.1) ),
               new TestValue("double_f",      IonType.FLOAT, Double.valueOf(-0.1) ),
               ...
               new TestValue("bdd_0",         IonType.DECIMAL, Double.valueOf(0.0) ),
               new TestValue("bdd_n0",        IonType.DECIMAL, Double.valueOf(-0.0) ),
               new TestValue("bdd_a",         IonType.DECIMAL, Double.valueOf(-1.0) ),
               new TestValue("bdd_b",         IonType.DECIMAL, Double.valueOf(1.0) ),
               new TestValue("bdd_c",         IonType.DECIMAL, Double.valueOf(-1e10) ),
               new TestValue("bdd_d",         IonType.DECIMAL, Double.valueOf(1e-10) ),
               new TestValue("bdd_e",         IonType.DECIMAL, Double.valueOf(0.1) ),
               new TestValue("bdd_f",         IonType.DECIMAL, Double.valueOf(-0.1) ),
...
//                   new TestValue("symbol_1",       IonType.SYMBOL, ""),
               ...
               new TestValue("symbol_9",       IonType.SYMBOL, Integer.valueOf(1) ),
