...
import com.amazon.ion.bytecode.bin11.OpcodeTestCases.INT16_EMITTING_OPCODE_CASES
import com.amazon.ion.bytecode.bin11.OpcodeTestCases.INT32_EMITTING_OPCODE_CASES
...
class ByteArrayBytecodeGenerator11Test {
    ...
    @MethodSource(
        ...
        REFERENCE_OPCODE_CASES, INT16_EMITTING_OPCODE_CASES, INT32_EMITTING_OPCODE_CASES, INT64_EMITTING_OPCODE_CASES,
        STRING_REFERENCE_OPCODE_CASES, LOB_REFERENCE_OPCODE_CASES
    )
