...
internal class ReferenceOpcodeHandlerTest {
     ...
     * - Input [ByteArray] with random bytes for the payload data
    ...
    private fun referenceOpcodeHandlerTestCases(): List<Arguments> {
        ...
        // <OpcodeHandler for OP_INT_REF>    , F5 0B <5 random bytes>, <correct I_INT_REF bytecode>    , 7
        // <OpcodeHandler for OP_DECIMAL_REF>, F6 0B <5 random bytes>, <correct I_DECIMAL_REF bytecode>, 7
        // ...
        instructions.forEach { (instruction, opcode) ->
            testTemplates.forEach {
                ...
                val random = Random(100 + opcode) // Seed so we get the same values every time
