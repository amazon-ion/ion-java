...
import static software.amazon.ion.impl._Private_IonConstants.BINARY_VERSION_MARKER_SIZE;
import static software.amazon.ion.impl._Private_Utils.EMPTY_BYTE_ARRAY;
import static software.amazon.ion.impl._Private_Utils.readFully;
...
import software.amazon.ion.impl._Private_IonConstants.HighNibble;
...
final class IonBinary
{
        ...
        extends BlockedBuffer.BlockedByteOutputStream
    {
        ...
        */
        ...
        /**
         * @see software.amazon.ion.impl.lite.ReverseBinaryEncoder#writeIonDecimalContent
         */
