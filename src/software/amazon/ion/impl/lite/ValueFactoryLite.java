...
import software.amazon.ion.impl._Private_LocalSymbolTableFactory;
import software.amazon.ion.impl._Private_Utils;
import software.amazon.ion.impl._Private_ValueFactory;
...
{
    protected final _Private_LocalSymbolTableFactory _lstFactory;
    private ContainerlessContext _context;

    ValueFactoryLite()
    {
        _lstFactory = _Private_Utils.newLocalSymbolTableAsStructFactory(this);
    }
